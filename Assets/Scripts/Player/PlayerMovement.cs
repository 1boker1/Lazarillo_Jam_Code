...
public class PlayerMovement : MonoBehaviour {
    ...
    {
        _MoveSpeed = _NormalMoveSpeed;
        PlayerManager._Instance.Running = false;
    }

    public virtual void Run()
    {
        _MoveSpeed = _RunMoveSpeed;
        PlayerManager._Instance.Running = true;
    }
    ...
    public void Update()
    {
        ...
        if (PlayerManager._Instance.Running)
        {
            PlayerManager._Instance.UseStamina();
        }
    ...
    public void GetMouseInput (float Yawn, float Pitch)
    {
        mouseX = Yawn;
        mouseY = Pitch;
    }
